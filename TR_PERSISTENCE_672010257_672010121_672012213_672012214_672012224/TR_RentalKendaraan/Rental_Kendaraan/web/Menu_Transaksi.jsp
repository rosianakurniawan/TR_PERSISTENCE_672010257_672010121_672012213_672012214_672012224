...
<html class="no-js" lang="en">
    ...
    <body>
                ...
                <section class="top-bar-section">
                    ...
                    <ul class="right">
                        ...
                        <li class="has-dropdown active">
                            ...
                            <ul class="dropdown">
                                <li class="active"><a href="transaksiSer">Mobil</a></li>
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${transaksi}" var="tr">
                                <tr>
                                    ...
                                    <td>
                                        <a href="hapusTransSer?idtrans=${tr.idTrans}" class="label alert">Delete</a>
                                        <a href="editTransSer?idtrans=${tr.idTrans}" class="label">Stop</a>
                                        <a href="ViewDetail?idtrans=${tr.idTrans}" class="label success">View</a>
                                    </td>
                                </tr>
        ...
        <div id="myModal" class="reveal-modal small" data-reveal 
            ...
            <form action="tambahTransSer" method="post" >
                ...
                <table style="width: 300px">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>
                                Kembali<input type="data" id="kembali" disabled="true" name="kembali"/>
                            </th>                            
                        </tr>
                    </thead>
                </table>
