    ...
    <body>
                    ...
                    <ul class="right">
                        ...
                        <li class="has-dropdown active">
                            ...
                            <ul class="dropdown">
                                ...
                                <li class="active"><a href="">Rekap Transaksi</a></li>
                            </ul>
                        </li>
        ...
        <div class="row">
            <div class="large-12 columns" >
                <br/>
                <div class="panel">
                    <h3>Data Rekapan Semua Transaksi</h3>
                    <br/>
                    <% String id = (String) session.getAttribute("userID");%>
                    <p>ID Rental Anda = <%=id%></p>
                </div>
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${transaksi}" var="tr">
                                <tr>
                                    ...
                                    <td>${tr.statusTransaksi}</td>
                                    <td>
                                        
                                        <a href="ViewAllTransDetail?idtrans=${tr.idTrans}" class="label success">View</a>
                                    </td>
                                </tr>
