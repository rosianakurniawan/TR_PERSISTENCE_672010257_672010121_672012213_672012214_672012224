 ...
 * @author RUBY
 */
public class updateTransSer extends HttpServlet {
...
//        out.println(b);
        if (alamat.equals("") || a.equals("") || bayar.equals("") || b.equals("") ||
            ...
            out.println("alert('Data Ada yang Kosong, Silakan di isi'); window.location.href='editTransSer'");
            out.println("</script>");
            ...
            try {
                ...
                out.println("alert('Data Telah Lunas...'); window.location.href='transaksiSer'");
                out.println("</script>");
            } catch (Exception e) {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Data GAGAL Ditambah...'); window.location.href='editTransSer'");
                out.println("</script>");
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(updateTransSer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
