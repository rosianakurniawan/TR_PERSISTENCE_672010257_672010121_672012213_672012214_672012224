 ...
 * @author RUBY
 */
public class tambahTransSerMotor extends HttpServlet {
...
//        tr.setTarif(parseDoubleSafely(tarif));
//        tr.setAmbil(a);
//        tr.setIdRental(ren);
//        tr.setOverTime(over);
//        tr.setBayar(bayar);
...
//
//        out.println(tr.getAlamat());
//        out.println(tr.getAmbil());
//        out.println(tr.getBayar());
//        out.println(tr.getIdRental());
//        out.println(tr.getIdTrans());
//        out.println(tr.getKembali());
//        out.println(tr.getLamaSewa());
//        out.println(tr.getNamaSewa());
//        out.println(tr.getNoTelp());
//        out.println(tr.getOverTime());
//        out.println(tr.getPlatNo());
//        out.println(tr.getStatusTransaksi());
//        out.println(tarif);
        if (nSewa.equals("") || alamat.equals("") || telp.equals("")
            ...
            out.println("alert('Data Ada yang Kosong, Silakan di isi'); window.location.href='transaksiSerMotor'");
            out.println("</script>");
...
//              //jquery TImer & datetimepicker  
                ...
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Data Berhasil Ditambah...'); window.location.href='transaksiSerMotor'");
                out.println("</script>");
            } catch (Exception e) {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Data GAGAL Ditambah...'); window.location.href='transaksiSerMotor'");
                out.println("</script>");
            }
