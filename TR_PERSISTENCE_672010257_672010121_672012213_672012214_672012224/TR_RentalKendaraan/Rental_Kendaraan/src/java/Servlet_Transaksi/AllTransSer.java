 ...
 * @author RUBY
 */
public class AllTransSer extends HttpServlet {
EntityManagerFactory emf = Persistence.createEntityManagerFactory("Rental_KendaraanPU");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id_session != null) {
            request.setAttribute("transaksi", tdao.getAllTransLunas(statT, rent));
            request.setAttribute("kend", ken);
            RequestDispatcher rd = request.getRequestDispatcher("Rekap_Transaksi.jsp");
